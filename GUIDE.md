...
App Version — это **зафиксированный снапшот** набора образов. Версия автоматически привязывается к конфигурации `default`. Инстансы запускаются именно из версий.
